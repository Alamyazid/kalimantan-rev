...
#download
wget -O /usr/local/bin/PDirect.py https://raw.githubusercontent.com/alamyazid/kalimantan-rev/main/install/PDirect.py
...
[Unit]
Description=Python Edu Proxy Script By TuanYZ
Documentation=https://t.me/Tuanyz
After=network.target nss-lookup.target
[Service]
Type=simple
User=root
...
wget -O /usr/local/bin/ovpn.py https://raw.githubusercontent.com/alamyazid/kalimantan-rev/main/install/ovpn.py
